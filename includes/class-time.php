...
class Edifice_Time {
    ...
    public static function get_all(array $args = []): array {
        global $wpdb;
        $tt = $wpdb->prefix . 'edifice_time_entries';
    ...
    public static function get_active_timer(): ?array {
        $timer = get_option('edifice_active_timer');
    ...
    public static function start_timer(array $data): bool {
        ...
        update_option('edifice_active_timer', [
    ...
    public static function stop_timer(): array|false {
        ...
        delete_option('edifice_active_timer');
    ...
    public static function save(array $data): int|false {
        global $wpdb;
        $t = $wpdb->prefix . 'edifice_time_entries';
        $fields = [
    ...
    public static function delete(int $id): bool {
        global $wpdb;
        return (bool)$wpdb->delete($wpdb->prefix . 'edifice_time_entries', ['id' => $id]);
    }
